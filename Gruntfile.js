        ...
        concat: {
            ...
            js: {
                src: [
                    ...
                    // Angular
                    'vendor/angular/angular-1.5.11/angular.min.js',
                    'vendor/upload/angular-file-upload.min.js',
                    'vendor/angular/angular-1.5.11/angular-route.min.js',
                    'vendor/angular/angular-1.5.11/angular-resource.min.js',
                    'vendor/angular/angular-1.5.11/angular-cookies.min.js',
                    'vendor/angular/angular-1.5.11/angular-messages.min.js',
                    // Bootstrap
